...
if __name__ == '__main__':
    ...
    parser.add_argument('--group_name', type=str, default='kote_KoRoBERTa', help='wandb logger group name')
    ...
    model = transformers.AutoModelForSequenceClassification.from_pretrained("klue/roberta-base", num_labels=44,
                                                                            problem_type="multi_label_classification")
    tokenizer = transformers.AutoTokenizer.from_pretrained("klue/roberta-base")
